...
items = {
    { "thermalfoundation:material",         161, 256, 256 }, -- Electrum Ingot
    { "thermalfoundation:material",         162, 256, 256 }, -- Invar Ingot
    { "thermalfoundation:material",         163, 256, 256 }, -- Bronze Ingot
    { "thermalfoundation:material",         164, 256, 256 }, -- Constantan Ingot
    { "thermalfoundation:material",         165, 256, 256 }, -- Signalum Ingot
    { "thermalfoundation:material",         166, 256, 256 }, -- Lumium Ingot
    { "thermalfoundation:material",         167, 256, 256 }, -- Enderium Ingot
    { "appliedenergistics2:material",       24 , 1024, 256 }, -- Engineering Processor
    { "appliedenergistics2:material",       23 , 1024, 256 }, -- Calculation Processor
    { "appliedenergistics2:material",       22 , 1024, 256 }, -- Logic Processor
    { "appliedenergistics2:material",       10 , 1000, 256 }, -- Pure Certus Quartz Crystal
    { "appliedenergistics2:material",       7  , 1000, 256 }, -- Fluix Crystal
